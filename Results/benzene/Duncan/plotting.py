...
plt.plot(data[:,0], data[:,1], "k.", color = 'navy', label = "MCTDH")

#data2 = np.loadtxt("DM_Q_focused.txt", dtype = float)
#plt.plot(data2[:,0] / fs_to_au, data2[:,1], "k-", color = 'green', label = "SPINLSC_Q_focused")
#
...
plt.plot(data4[:,0] / fs_to_au, data4[:,1], "k-", color = 'black', label = "SPINLSC_W_focused")
...
data66 = np.loadtxt("Cnn_1_benzene_W_fcs.txt", dtype = float)
plt.plot(data66[:,0] / fs_to_au, data66[:,1], "k-", color = 'cyan', label = "SPINLSC_W_focused_Duncan")

data77 = np.loadtxt("Cnn_1_benzene_W_smpl.txt", dtype = float)
plt.plot(data77[:,0] / fs_to_au, data77[:,1] / 0.33199, "k-", color = 'orange', label = "SPINLSC_W_sampled_Duncan")
...
plt.plot(data6[:,0], data6[:,1], "k.", color = 'navy', label = "MCTDH")

#data7 = np.loadtxt("DM_Q_focused.txt", dtype = float)
#plt.plot(data7[:,0] / fs_to_au, data7[:,9], "k-", color = 'green', label = "SPINLSC_Q_focused")
#
...
plt.plot(data9[:,0] / fs_to_au, data9[:,9], "k-", color = 'black', label = "SPINLSC_W_focused")
...
#data6 = np.loadtxt("Cnn_1_benzene_W_fcs.txt", dtype = float)
plt.plot(data66[:,0] / fs_to_au, data66[:,2], "k-", color = 'cyan', label = "SPINLSC_W_focused_Duncan")

#data7 = np.loadtxt("Cnn_1_benzene_W_smpl.txt", dtype = float)
plt.plot(data77[:,0] / fs_to_au, data77[:,2] / 0.332, "k-", color = 'orange', label = "SPINLSC_W_sampled_Duncan")
...
plt.plot(data11[:,0], data11[:,1], "k.", color = 'navy', label = "MCTDH")

#data12 = np.loadtxt("DM_Q_focused.txt", dtype = float)
#plt.plot(data12[:,0] / fs_to_au, data12[:,17], "k-", color = 'green', label = "SPINLSC_Q_focused")
#
...
plt.plot(data14[:,0] / fs_to_au, data14[:,17], "k-", color = 'black', label = "SPINLSC_W_focused")
...
#data6 = np.loadtxt("Cnn_1_benzene_W_fcs.txt", dtype = float)
plt.plot(data66[:,0] / fs_to_au, data66[:,3], "k-", color = 'cyan', label = "SPINLSC_W_focused_Duncan")

#data7 = np.loadtxt("Cnn_1_benzene_W_smpl.txt", dtype = float)
plt.plot(data77[:,0] / fs_to_au, data77[:,3] / 0.332, "k-", color = 'orange', label = "SPINLSC_W_sampled_Duncan")
