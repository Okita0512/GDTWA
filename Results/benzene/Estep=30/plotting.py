...
plt.plot(data5[:,0] / fs_to_au, data5[:,1], "k-", color = 'red', label = "SPINLSC_W_sampled")
...
plt.plot(data10[:,0] / fs_to_au, data10[:,9], "k-", color = 'red', label = "SPINLSC_W_sampled")
...
plt.plot(data15[:,0] / fs_to_au, data15[:,17], "k-", color = 'red', label = "SPINLSC_W_sampled")
